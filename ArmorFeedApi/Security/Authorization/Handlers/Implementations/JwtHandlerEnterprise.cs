...
public class JwtHandlerEnterprise : IJwtHandler<Enterprise>
{
    private readonly AppSettings _appSettings;

    public JwtHandlerEnterprise(IOptions<AppSettings> appSettings)
    {
        _appSettings = appSettings.Value;
    }

    public string GenerateToken(Enterprise user)
    {
