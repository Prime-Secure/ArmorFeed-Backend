...
public class ShipmentService: IShipmentService
{
    ...
    public async Task<IEnumerable<Shipment>> ListByVehicleId(int vehicleId)
    {
        return await _shipmentRepository.FindByVehicleId(vehicleId);
    }
    ...
    public async Task<ShipmentResponse> UpdateStatusWhenConfirmed(int id, Shipment shipment)
    {
        var existingShipment = await _shipmentRepository.FindByIdAsync(id);
        ...
        if (shipment.UserConfirmed & shipment.EnterpriseConfirmed)
        {
